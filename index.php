            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 ml-auto text-center mb-5 mb-lg-0">
                        ...
                        <div class="text-white">+880 1761 131882</div>
                    </div>
                    <div class="col-lg-4 mr-auto text-center">
                        <i class="fas fa-envelope fa-3x mb-3 text-muted"></i>
                        <!-- Make sure to change the email address in BOTH the anchor text and the link target below!-->
                        <a class="d-block" href="mailto: morsa@demo.com">morsa@demo.com</a>
                    </div>
                </div>
            </div>
            <br>
            <div class="container"><div class="small text-center text-muted">Copyright © 2022 - Shohid Al Morsalin | morsalinsajeeb@gmail.com</div></div>
        </footer>
